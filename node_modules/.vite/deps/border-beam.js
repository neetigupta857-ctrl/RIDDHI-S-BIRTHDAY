...
function ta(t, e, a, r, o, s) {
  ...
  return {
    ...
    hue: o ? null : { prop: `--beam-hue-${s}`, range: 360, period: i.huePeriod, continuous: true }
  };
}
function Q(t, e, a) {
...
function ma() {
  const [t, e] = (0, import_react.useState)(() => typeof window > "u" || window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light");
...
var za = (0, import_react.forwardRef)(
  function({
    children: e,
    size: a = "md",
    colorVariant: r = "colorful",
    theme: o = "dark",
    staticColors: s = false,
    duration: i,
    active: c = true,
    borderRadius: p,
    brightness: b,
    ...
    const $ = (0, import_react.useId)().replace(/:/g, "-"), w = ma(), y = (0, import_react.useRef)(null), [x, X] = (0, import_react.useState)(c), [u, v] = (0, import_react.useState)(false), [S, J] = (0, import_react.useState)(true), [G, ee] = (0, import_react.useState)(null), [j, A] = (0, import_react.useState)({ x: 1, y: 1 });
    (0, import_react.useEffect)(() => {
      ...
      return M.observe(h, { childList: true, subtree: false }), () => M.disconnect();
    }, [p, e]), (0, import_react.useEffect)(() => {
      c && !x && !u ? X(true) : !c && x && !u && v(true);
    }, [c, x, u]), (0, import_react.useEffect)(() => {
      const h = y.current;
    ...
    const ae = (0, import_react.useCallback)(
      (h) => {
        const F = h.animationName;
        F.includes("fade-out") ? (X(false), v(false), g == null || g()) : F.includes("fade-in") && (f == null || f()), W == null || W(h);
      },
      [f, g, W]
    ), R = $a(o, w), O = ne[a][R], re = Le[a], te = a === "pulse-inner" || a === "pulse-outside", le = p ?? G ?? re.borderRadius, T = i ?? (a === "line" ? 3.1 : te ? 2.3 : 1.96), de = m ?? O.saturation, fe = b ?? O.brightness ?? 1.3, N = a === "line" ? Math.min(n, 13) : n, V = r === "mono" ? true : s, Se = (0, import_react.useMemo)(
      () => oa({
        id: $,
        borderRadius: le,
    ...
    const Re = (0, import_react.useCallback)(
      (h) => {
    ...
    return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      (0, import_jsx_runtime.jsx)("style", { children: Se }),
      (0, import_jsx_runtime.jsxs)(
        "div",
        {
          ...
          children: [
            e,
            (0, import_jsx_runtime.jsx)("div", { "data-beam-bloom": true })
          ]
        }
      )
    ] });
